...
module.exports = function gulpStylelint(options) {
  ...
  function onFile(file, encoding, done) {
    ...
    var lintPromise = file.sourceMap ? (0, _stylelint.lint)(localLintOptions).then(function (lintResult) {
      return (0, _applySourcemap2.default)(lintResult, file.sourceMap);
    }) : (0, _stylelint.lint)(localLintOptions);
