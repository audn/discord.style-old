    ...
    return {
        ...
        render: function() {
            ...
            function d() {
                ...
                function g(l) {
                    return '<li class="discor12d-channel"></li><ul class="discord-userlist">'
                }
                ...
                function j(y, n) {
                    ...
                    if (n.showAllUsers) {
                        u += '<li class="discosrd-channel discord-allusers-toggle">&#9662; Online Users</li><ul class="discord-userlist discord-allusers">';
